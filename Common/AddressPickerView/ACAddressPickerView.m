...
@interface ACAddressPickerView ()<UIPickerViewDelegate, UIPickerViewDataSource>
///<#注释#>
...
@implementation ACAddressPickerView
...
+ (instancetype)provincePickerViewWithProvinceBlock:(void(^)(NSString *province))provinceBlock {
    return [ACAddressPickerView addressPickerViewWithProvince:nil city:nil area:nil provinceBlock:provinceBlock cityBlock:nil areaBlock:nil showType:CZHAddressPickerViewTypeProvince];
}
...
+ (instancetype)cityPickerViewWithCityBlock:(void(^)(NSString *province, NSString *city))cityBlock {
    return [ACAddressPickerView addressPickerViewWithProvince:nil city:nil area:nil provinceBlock:nil cityBlock:cityBlock areaBlock:nil showType:CZHAddressPickerViewTypeCity];
}
...
+ (instancetype)areaPickerViewWithAreaBlock:(void(^)(NSString *province, NSString *city, NSString *area))areaBlock {
    return [ACAddressPickerView addressPickerViewWithProvince:nil city:nil area:nil provinceBlock:nil cityBlock:nil areaBlock:areaBlock showType:CZHAddressPickerViewTypeArea];
}
...
+ (instancetype)provincePickerViewWithProvince:(NSString *)province provinceBlock:(void(^)(NSString *province))provinceBlock {
    return [ACAddressPickerView addressPickerViewWithProvince:province city:nil area:nil provinceBlock:provinceBlock cityBlock:nil areaBlock:nil showType:CZHAddressPickerViewTypeProvince];
}
...
+ (instancetype)cityPickerViewWithProvince:(NSString *)province city:(NSString *)city cityBlock:(void(^)(NSString *province, NSString *city))cityBlock {
    return [ACAddressPickerView addressPickerViewWithProvince:province city:city area:nil provinceBlock:nil cityBlock:cityBlock areaBlock:nil showType:CZHAddressPickerViewTypeCity];
}
...
+ (instancetype)areaPickerViewWithProvince:(NSString *)province city:(NSString *)city area:(NSString *)area areaBlock:(void(^)(NSString *province, NSString *city, NSString *area))areaBlock {
    return [ACAddressPickerView addressPickerViewWithProvince:province city:city area:area provinceBlock:nil cityBlock:nil areaBlock:areaBlock showType:CZHAddressPickerViewTypeArea];
}
...
+ (instancetype)addressPickerViewWithProvince:(NSString *)province city:(NSString *)city area:(NSString *)area provinceBlock:(void(^)(NSString *province))provinceBlock cityBlock:(void(^)(NSString *province, NSString *city))cityBlock areaBlock:(void(^)(NSString *province, NSString *city, NSString *area))areaBlock  showType:(CZHAddressPickerViewType)showType{
    ...
    ACAddressPickerView *_view = [[ACAddressPickerView alloc] init];
...
- (void)czh_setView {
    ...
    toolBar.frame = CGRectMake(ll_WidthFromIphone6(10), 0, ScreenWidth - ll_WidthFromIphone6(20), CZH_ScaleHeight(55));
    toolBar.backgroundColor = CZHColor(0xf6f6f6);
    [containView addSubview:toolBar];
    [toolBar ll_setRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight CornerRadius:ll_WidthFromIphone6(6)];
    ...
    pickerView.frame = CGRectMake(toolBar.frame.origin.x, toolBar.czh_bottom, toolBar.frame.size.width, containView.czh_height - toolBar.czh_height);
...
{
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(ll_WidthFromIphone6(10), 0, (ScreenWidth - ll_WidthFromIphone6(20)) / 3, ll_WidthFromIphone6(30))];
    label.font = LL_FontFromiPhone6ByeSize(14);
    ...
    label.backgroundColor = LL_ColorWithHexStr(@"ffffff");
    return label;
}
