...
@implementation LLKeyChainManager
/*!
 创建生成保存数据查询条件
 */
+(NSMutableDictionary*) ll_keyChainIdentifier:(NSString*)identifier {
...
+(BOOL) ll_keyChainSaveData:(id)data withIdentifier:(NSString*)identifier{
    // 获取存储的数据的条件
    NSMutableDictionary * saveQueryMutableDictionary = [self ll_keyChainIdentifier:identifier];
    // 删除旧的数据
...
+(id) ll_keyChainReadData:(NSString*)identifier{
    id idObject = nil ;
    // 通过标记获取数据查询条件
    NSMutableDictionary * keyChainReadQueryMutableDictionary = [self ll_keyChainIdentifier:identifier];
    // 这是获取数据的时，必须提供的两个属性
...
+(BOOL)ll_keyChainUpdata:(id)data withIdentifier:(NSString*)identifier {
    // 通过标记获取数据更新的条件
    NSMutableDictionary * keyChainUpdataQueryMutableDictionary = [self ll_keyChainIdentifier:identifier];
    // 创建更新数据字典
...
+(void) ll_keyChainDelete:(NSString*)identifier {
    // 获取删除数据的查询条件
    NSMutableDictionary * keyChainDeleteQueryMutableDictionary = [self ll_keyChainIdentifier:identifier];
    // 删除指定条件的数据
