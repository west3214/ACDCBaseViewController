...
+(instancetype)ll_ColorWithHexStr:(NSString *)hexStr{
    ...
    return [UIColor ll_ColorWithRGBHex:hexNum];
}
...
+ (UIColor *)ll_RandomColor {
    return [[UIColor alloc]initWithRed:arc4random() % 255 / 255.0 green:arc4random() % 255 / 255.0 blue:arc4random() % 255 / 255.0 alpha:1];
}
@end
